...
export default function Testimonial() {
  return (
    <section id="testimonial" className="py-8 md:py-12 bg-background">
      <div className="container mx-auto px-4">
        ...
        <motion.div
          className="max-w-5xl mx-auto bg-card border border-border rounded-xl shadow-md p-8 relative"
        ...
        >
          ...
          <div className="mt-6">
            ...
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <h4 className="font-semibold text-lg text-foreground">Dr. Stefan Dech</h4>
                <p className="text-muted-foreground">Director of the German Remote Sensing Data Center, DLR, German Space Agency</p>
              </div>
            </div>
          </div>
        </motion.div>
